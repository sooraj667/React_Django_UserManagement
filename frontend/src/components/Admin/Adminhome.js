...
const Adminhome = () => {
  ...
  const handleSearch=()=>{
    const datas={
        searchvalue:admin.value.searchvalue
    }
    axiosInstance.post("adminsearch/",datas).then((res)=>{
        
        setUserDatas(()=>JSON.parse(JSON.stringify(res.data)))
  ...
  return (
    <div>
      ...
      <button
        className="btn btn-warning adduserbtn"
      ...
      {addUserState ? (
        <div class="addusercard ">
          ...
          <button onClick={addUserHandler} className="btn btn-success">
            Add User
          </button>
        </div>
      ) : (
      ...
      <div class="container mt-5">
        ...
        {editState ? (
          <div className="editcard">
            ...
            <button onClick={editUserHandler} className="btn btn-success">
              Submit
            </button>
